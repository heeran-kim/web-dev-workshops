...
INSERT INTO Listings (Title, Street, City, State, Rent, AvailableDate, IsFurnished, IsBillIncluded, Description, OwnerID)
    VALUES 
    ('Cozy Studio', '123 Elm Street', 'Sydney', 'NSW', 300, '2024-09-01', 1, 1, 
    ...
    ('Spacious House', '456 Oak Avenue', 'Melbourne', 'VIC', 600, '2024-09-15', 1, 0, 
    ...
    ('Modern Flat', '789 Pine Road', 'Brisbane', 'QLD', 400, '2024-10-01', 0, 1, 
...
INSERT INTO Reviews(Rating, Date, Review, ListingID, UserID)
    ...
    (4, '2024-07-30', 'Beautiful view and close to the beach. Would stay again.', 2, 2),
    (3, '2024-08-10', 'Nice loft but a bit noisy at night. Great access to downtown.', 3, 1);
...
SELECT
    U.Name,
    AVG(NT.Average) AS "Average",
    SUM(NT.Count) AS "Count"
